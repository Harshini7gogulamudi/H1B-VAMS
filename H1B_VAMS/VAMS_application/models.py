...
class UserDatabase(Model):
    ...
    role = models.CharField(max_length=10, choices=userOptions, blank=False)
    gender = models.CharField(max_length=10, choices=gender_options, blank=False)
    educationalBackground = models.CharField(max_length=100, blank=False, default='No Information Available')
